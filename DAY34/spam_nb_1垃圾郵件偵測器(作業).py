...
model = MLPClassifier()
model.fit(Xtrain, Ytrain)
print("Classification rate for MLPclassifier:", model.score(Xtest, Ytest))

from sklearn.neighbors import KNeighborsClassifier
model = KNeighborsClassifier()
model.fit(Xtrain, Ytrain)
print("Classification rate for KNeighborClassifier:", model.score(Xtest, Ytest))

from sklearn.svm import SVC
model = SVC()
model.fit(Xtrain, Ytrain)
print("Classification rate for SVC:", model.score(Xtest, Ytest))
